    ...
    return (
        <Router>
            ...
            <Switch>
                ...
                <Route
                    exact
                    path={process.env.PUBLIC_URL + "/checkout/standard"}
                    render={(props) => (
                        <Fragment>
                ...
                <Route
                    exact
                    path={process.env.PUBLIC_URL + "/checkout/select"}
                    render={(props) => (
                        <Fragment>
                ...
                <Route
                    exact
                    path={process.env.PUBLIC_URL + "/checkout/amd"}
                    render={(props) => (
                        <Fragment>
                ...
                <Route
                    exact
                    path={process.env.PUBLIC_URL + "/checkout/intel"}
                    render={(props) => (
                        <Fragment>
                ...
                <Route
                    exact
                    path={process.env.PUBLIC_URL + "/demo/end"}
                    component={Demo}
                />
            </Switch>
